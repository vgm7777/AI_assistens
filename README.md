...
- **Savvy (https://suvvy.ai/)**  
  Сервис для разработки и внедрения ИИ-ассистентов. Savvy позволяет легко интегрировать ассистента с различными каналами коммуникации (например, сайт, чаты) и настраивать его поведение, а также связывать его с Google Календарем.
